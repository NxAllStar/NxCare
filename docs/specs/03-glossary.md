...
| Owner (của task) / Task owner | Bác sĩ, kỹ thuật viên hoặc phòng bạnu trách nhiệm thực hiện một task / The doctor, technician, or room responsible for a task | Người phụ trách | [FR-04](05-functional-requirements.md#fr-04), `Task.owner_id` |
