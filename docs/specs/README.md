---
title: "Specifications - VAIC - AI Care Pathway Coordinator"
sidebar_label: "Overview"
description: "Index and reading guide for the VAIC - AI Care Pathway Coordinator specification set."
tags: [specs, vaic]
---

# Specifications - VAIC - AI Care Pathway Coordinator

Dieu phoi vien AI van hanh lo trinh kham chua benh, giam thoi gian cho va un tac bang mot doi ngu agent phoi hop. / An AI coordination layer that orchestrates the hospital care pathway to cut patient wait times and ease congestion through a team of cooperating agents.

This directory is the requirements contract for VAIC - AI Care Pathway Coordinator. Code that disagrees with a section
