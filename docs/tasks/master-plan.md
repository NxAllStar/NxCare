...
| TASK-038 | Wire the patient app to the real Care Plan backend (GET /api/careplan/patient/{id}/active) - real-time SSE seam + console->backend->patient app wired, merged to main via PR #13 | frontend-ui-dev | TASK-027, TASK-013 | P1 | 2 | Done |
