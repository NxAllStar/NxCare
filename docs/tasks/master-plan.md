...
| TASK-012 | A/B eval: no-visibility baseline vs AI-guided route (FR-23) + demo script + metrics - retargeted from FIFO-vs-agent-pipeline, 2026-07-18 | simulator-dev | TASK-006, TASK-027 | P2 | 3 | Done |
