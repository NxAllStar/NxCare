---
# tests/**/*.py, frontend/src/**/*.test.{ts,tsx}, e2e/**/*.spec.ts and src/vaic/**/*.py, frontend/src/**/*.{ts,tsx} each expand to one quoted glob per line
paths:
  - "tests/**/*.py"
...
- Target for business logic: **80%**. It is a floor, not a goal.
