...
- **scope**: one of intake, careplan, journey, forecast, agent-core, simulator, frontend, data, specs, agents, infra. A new scope is added to this list in the same change that
  first uses it.
...
- No commit directly to `main` (hook-enforced). One branch per task.
